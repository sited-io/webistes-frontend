...
/**
 * @generated from enum peoplesmarkets.report.v1.ReportType
 */
...
proto3.util.setEnumType(ReportType, "peoplesmarkets.report.v1.ReportType", [
...
/**
 * @generated from message peoplesmarkets.report.v1.CreateReportRequest
 */
export class CreateReportRequest extends Message<CreateReportRequest> {
  /**
   * @generated from field: peoplesmarkets.report.v1.ReportType report_type = 1;
   */
  ...
  static readonly typeName = "peoplesmarkets.report.v1.CreateReportRequest";
...
/**
 * @generated from message peoplesmarkets.report.v1.CreateReportResponse
 */
export class CreateReportResponse extends Message<CreateReportResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "peoplesmarkets.report.v1.CreateReportResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
