...
// @generated from file peoplesmarkets/pagination/v1/pagination.proto (package peoplesmarkets.pagination.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message peoplesmarkets.pagination.v1.Pagination
 */
export class Pagination extends Message<Pagination> {
  ...
  static readonly typeName = "peoplesmarkets.pagination.v1.Pagination";
...
/**
 * @generated from message peoplesmarkets.pagination.v1.PaginationRequest
 */
export class PaginationRequest extends Message<PaginationRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "peoplesmarkets.pagination.v1.PaginationRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message peoplesmarkets.pagination.v1.PaginationResponse
 */
export class PaginationResponse extends Message<PaginationResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "peoplesmarkets.pagination.v1.PaginationResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "page", kind: "scalar", T: 13 /* ScalarType.UINT32 */ },
    { no: 2, name: "size", kind: "scalar", T: 13 /* ScalarType.UINT32 */ },
